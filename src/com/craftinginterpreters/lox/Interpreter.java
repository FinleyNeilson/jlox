    ...
    public Object visitBinaryExpr(Expr.Binary expr) {
        ...
        return switch (expr.operator.type()) {
            case GREATER, GREATER_EQUAL, LESS, LESS_EQUAL -> {
                ...
                yield switch (expr.operator.type()) {
                    ...
                    default ->
                            throw new RuntimeError(expr.operator, "Unexpected relational operator in evaluation switch.");
                };
            }
            ...
            case PLUS -> {
                if (left instanceof Double leftOp && right instanceof Double rightOp) {
                    yield leftOp + rightOp;
                } else if (left instanceof String leftOp && right instanceof String rightOp) {
                    yield leftOp + rightOp;
                } else if (left instanceof String leftOp && right instanceof Double) {
                    yield leftOp + right;
                } else if (left instanceof Double && right instanceof String rightOp) {
                    yield left + rightOp;
                } else {
