...
class Resolver implements Expr.Visitor<Void>, Stmt.Visitor<Void> {
    ...
    private void resolveFunction(Stmt.Function function, FunctionType type) {
        resolveParameters(function.params, function.body, type);
    }

    private void resolveLambda(Expr.Lambda lambda, FunctionType type) {
        resolveParameters(lambda.params, lambda.body, type);
    }

    private void resolveParameters(List<Token> params, List<Stmt> body, FunctionType type) {
